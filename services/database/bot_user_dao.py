...
def update_or_create_tg_user(data: Chat | User):
    ...
    if create_status is False:
        logger.info(f'Successfully updated user in DB {first_name} {last_name} {username}')
    else:
        logger.info(f'Successfully created user in DB {first_name} {last_name} {username}')
